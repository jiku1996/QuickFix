    ...
    void Update()
    {
        ...
        if (values.Count == 5 && string_val.Count == 5)
        {
            ...
            if (count != 5)
            {
                ...
                {
                    if (Input.GetAxis("DpadH") < 0 || Input.GetAxis("DpadH") > 0)
                    {
                        if (Input.GetAxis("DpadH") == values[count])
                        {
                ...
                if (string_val[count] == "Y")
                {
                    if (Input.GetAxis("DpadA") < 0 || Input.GetAxis("DpadA") > 0)
                    {
                        if (Input.GetAxis("DpadA") == values[count])
                        {
